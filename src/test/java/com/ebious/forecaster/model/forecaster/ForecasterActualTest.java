...
class ForecasterActualTest {

    Forecaster forecaster = new ForecasterActual();
    DataSetSupplier dataSetSupplier = new CsvDataSetSupplier();

    @Test
    void actualForecasterByDate() {
        ForecastDate date = new ForecastDate(LocalDate.parse("26.03.2022", DateUtils.PARSE_FORMATTER), Period.NONE);
